  ...
  return (
    <div className="bg-primary/60 min-h-screen w-full overflow-hidden relative">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="container h-full flex flex-col justify-center items-center md:items-start text-center md:text-left px-4 md:px-12 lg:px-24 xl:px-32 pt-24 md:pt-32">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="absolute bottom-20 xl:bottom-0 w-full flex justify-center md:justify-end items-end px-6 sm:px-12 xl:pr-24"
      >
